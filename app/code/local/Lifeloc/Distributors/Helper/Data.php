 ...
 * @author Magento
 */
class Lifeloc_Distributors_Helper_Data extends Mage_Core_Helper_Data
{
    /**
...
//    const XML_PATH_ITEMS_PER_PAGE     = 'distributors/view/items_per_page';
 ...
 //   const XML_PATH_DAYS_DIFFERENCE    = 'distributors/view/days_difference';
     ...
     */
    protected $_distributorsItemInstance;
...
*/
     ...
     */
    public function getDistributorsItemInstance()
    {
        if (!$this->_distributorsItemInstance) {
            $this->_distributorsItemInstance = Mage::registry('distributors_item');

            if (!$this->_distributorsItemInstance) {
                Mage::throwException($this->__('Distributor instance does not exist in Registry'));
            }
        }

        return $this->_distributorsItemInstance;
    }
}
